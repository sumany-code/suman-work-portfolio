...
export default function App() {
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900 flex justify-center p-6">
      <div className="w-full max-w-4xl">
        ...
        {/* Summary */}
        <section className="bg-white p-6 rounded-2xl shadow mb-8 text-sm leading-relaxed">
        ...
        {/* Skills */}
        <section className="bg-white p-6 rounded-2xl shadow mb-8 text-sm">
          <h2 className="text-xl font-semibold mb-3">Skills</h2>
          <div className="flex flex-wrap gap-2">
            {[
              "Java", "J2EE","XML/JSON","Spring Boot", "System Design","Data Structures & Algorithms",
              "Microservices Architecture","OOPs","REST API","Design Patterns","SQL", "PostgreSQL",
              "Azure", "Kafka", "Docker", "Kubernetes","Agile Methodology","SDLC", "CI/CD","JUnit","Mockito"
            ].map(skill => (
        ...
        {/* Education */}
        <section className="bg-white p-6 rounded-2xl shadow text-sm mb-12">
